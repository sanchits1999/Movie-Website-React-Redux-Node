...
import { getupcoming } from "../api/getters"
...
const Upcoming = (props) => {
    ...
    useEffect(() => {
        ...
        getupcoming(props.page).then((res) => {
            props.setupcomingmovies(res.response)
        }).catch(() => {
...
const MapstateToprops = (state) => {
    return {
        movies: state.r.UpcomingMovies.movies,
        page: state.r.UpcomingMovies.page,
