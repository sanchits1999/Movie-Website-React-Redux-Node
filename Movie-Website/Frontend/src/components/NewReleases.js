...
import { getlatest } from "../api/getters"
import { connect } from "react-redux"
import { Link, Redirect } from "react-router-dom"
import { setLatestmovies } from "../actions/actions"
...
const NewReleases = (props) => {
    ...
    useEffect(() => {
        ...
        getlatest(props.page).then((res) => {
            props.setlatestmovies(res.response)
        }).catch(() => {
...
const MapstateToprops = (state) => {
    return {
        movies: state.r.LatestMovies.movies,
        page: state.r.LatestMovies.page,
